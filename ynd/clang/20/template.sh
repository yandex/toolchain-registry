...
{% block llvm_patches %}
01-PR-144130-backport-llvm-cov-baseline-coverage.patch
02-PR159119-backport-mcdc-executed-test-vectors.patch
03-PR-187517-backport-mcdc-non-executed-test-vectors.patch
04-PR-192457-backport-llvm-cov-json-streaming.patch
